...
import heroBg from "../assets/SponsorshipLogo/bg1.png";
import heroCard from "../assets/SponsorshipLogo/card.png";

{
  /* PACKAGES */
}
import platinumLogo from "../assets/SponsorshipLogo/platinum.png";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="mt-8 text-6xl lg:text-6xl font-black leading-tight">
                ...
                <span className="text-yellow-600">Official Sponsor</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-5 mt-10">
                ...
                <a
                  href="/brochure/ETES-2026-Brochure.pdf"
                  download
                  className="px-8 py-4 rounded-full border border-yellow-500 text-yellow-400 hover:bg-yellow-500 hover:text-black transition inline-flex items-center justify-center"
                >
                  Download Brochure
                </a>
              </div>
          ...
          >
            ...
            <div className="bg-white p-10 flex flex-col justify-center items-center text-center">
              ...
              <button
                ...
                className="mt-8 px-8 py-3 rounded-full bg-yellow-500 text-white font-semibold hover:bg-yellow-600 transition"
              >
                Register Now
              </button>
            </div>
            ...
            <div className="bg-[#fafafa] p-10 flex flex-col justify-center">
              ...
              <button
                onClick={() => navigate("/register")}
                className="mt-10 w-fit px-7 py-3 rounded-full border border-yellow-500 text-yellow-600 font-semibold hover:bg-yellow-500 hover:text-white transition"
              >
                Book Your Seat
              </button>
            </div>
