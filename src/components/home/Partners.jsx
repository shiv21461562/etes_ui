        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-x-10 gap-y-14">
          {sponsorData.map((category, index) => (
            ...
            >
              ...
              {/* Logos */}
              {category.title === "Logo Sponsor" ? (
                <div className="grid grid-cols-2 gap-x-10 gap-y-6 justify-items-center">
                  {category.logos.map((logo, i) => (
                    <div className="sponsor-card h-24 flex items-center justify-center">
                      <img
                        src={logo.image}
                        alt={category.title}
                        className="max-w-[150px] max-h-[64px] object-contain select-none"
                ...
                <div className="flex flex-col gap-6">
                  {category.logos.map((logo, i) => (
                    <div
                      key={i}
                      className="sponsor-card h-24 flex items-center justify-center"
                    >
                      <img
                        src={logo.image}
                        alt={category.title}
