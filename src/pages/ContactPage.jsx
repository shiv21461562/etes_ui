            ...
            <div className="mt-12 space-y-8">
              <div className="border-l-2 border-[#c9962f] pl-5 py-1">
                ...
                <a
                  ...
                  className="mt-3 inline-block text-gray-300 hover:text-[#25D366] transition"
                >
                  +91 98731 68426
                </a>
              </div>
              ...
              <div className="border-l-2 border-[#c9962f] pl-5 py-1">
                ...
                <p className="mt-3 font-semibold">Neha Chauhan</p>
                ...
                <a
                  ...
                  className="mt-2 inline-block text-gray-300 hover:text-[#f3d488] transition"
                >
                  neha@electricalmirror.net
                </a>

                <p className="text-gray-300">+91 7428 693 331</p>
              </div>
              ...
              <div className="border-l-2 border-[#c9962f] pl-5 py-1">
                ...
                <p className="mt-3 font-semibold">Hemant</p>

                <p className="text-gray-400">Manager – Sales &amp; Marketing</p>
                ...
                <p className="text-gray-300">+91 9999395282</p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-10 space-y-7">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-1">Scope Complex</p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-1">9:00 AM – 5:00 PM</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 mt-1">info@etesevent.com</p>
                </div>
              </div>
            </div>
          </div>
